...
export interface GroupChannelCreateProps<User> {
  Fragment: {
    ...
    onBeforeCreateChannel?: (
      ...
      | SendbirdGroupChannelCreateParams
      | Promise<SendbirdGroupChannelCreateParams>
...
export type GroupChannelCreateFragment<User> = CommonComponent<
...
export type GroupChannelInviteFragment<User> = CommonComponent<
...
export type GroupChannelMembersFragment<User> = CommonComponent<
