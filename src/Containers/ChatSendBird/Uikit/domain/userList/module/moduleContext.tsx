...
export const UserListContextsProvider: UserListModule<any>['Provider'] = ({
  children,
  headerTitle,
  headerRight,
}) => {
  ...
  return (
    <ProviderLayout>
      <UserListContexts.Fragment.Provider
        value={{ headerTitle, headerRight: headerRight(selectedUsers) }}
      >
        <UserListContexts.List.Provider
          value={{ selectedUsers, setSelectedUsers }}
        >
          {children}
        </UserListContexts.List.Provider>
      </UserListContexts.Fragment.Provider>
