...
export interface GroupChannelProps {
  Fragment: {
    ...
    onBeforeSendFileMessage?: (
      ...
      | SendbirdFileMessageCreateParams
      | Promise<SendbirdFileMessageCreateParams>
    onBeforeSendUserMessage?: (
      params: SendbirdUserMessageCreateParams,
    ) =>
      | SendbirdUserMessageCreateParams
      | Promise<SendbirdUserMessageCreateParams>
  ...
  MessageList: {
    ...
    onResendFailedMessage: (
      failedMessage: SendbirdUserMessage | SendbirdFileMessage,
    ) => Promise<void>
    onDeleteMessage: (
...
export type GroupChannelFragment = CommonComponent<
  GroupChannelProps['Fragment']
>
