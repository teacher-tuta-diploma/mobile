...
const createGroupChannelFragment = (
  initModule?: Partial<GroupChannelModule>,
): GroupChannelFragment => {
  ...
  return ({
    ...
    const onSendUserMessage: GroupChannelProps['Input']['onSendUserMessage'] =
      useFreshCallback(async text => {
        ...
        console.log(
          '🛠 LOG: 🚀 --> ~ file: createGroupChannelFragment.tsx ~ line 99 ~ processedParams',
          processedParams,
        )
        console.log(
          '🛠 LOG: 🚀 --> --------------------------------------------------------------------------------------------------🛠 LOG: 🚀 -->',
    ...
    const onUpdateFileMessage: GroupChannelProps['Input']['onUpdateFileMessage'] =
      useFreshCallback(async (editedFile, message) => {
    ...
    const onUpdateUserMessage: GroupChannelProps['Input']['onUpdateUserMessage'] =
      useFreshCallback(async (editedText, message) => {
