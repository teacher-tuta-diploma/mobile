...
export const useLocalization = () => {
  ...
  if (!value) {
    throw new Error('LocalizationContext is not provided')
  }
  return value
}
...
export const usePlatformService = () => {
  ...
  if (!value) {
    throw new Error('PlatformServiceContext is not provided')
  }
  return value
}
...
export const useSendbirdChat = () => {
  ...
  if (!value) {
    throw new Error('SendbirdChatContext is not provided')
  }
  return value
}
