...
function getAndroidStoragePermissionsByAPILevel(
...
const createNativeFileService = ({
  ...
  const cameraPermissions: Permission[] = Platform.select({
    ios: [
      permissionModule.PERMISSIONS.IOS.CAMERA,
      permissionModule.PERMISSIONS.IOS.MICROPHONE,
    ],
  ...
  class NativeFileService implements FileServiceInterface {
    ...
    async requestMediaLibraryPermission(): Promise<boolean> {
      ...
      console.log(
        '🛠 LOG: 🚀 --> ~ file: createFileService.native.ts ~ line 101 ~ NativeFileService ~ requestMediaLibraryPermission ~ status',
        status,
      )
      console.log(
        '🛠 LOG: 🚀 --> ----------------------------------------------------------------------------------------------------------------------------------🛠 LOG: 🚀 -->',
    ...
    async openMediaLibrary(
    ...
    ): Promise<FilePickerResponse[] | null> {
      /**
      ...
      console.log(
        '🛠 LOG: 🚀 --> ~ file: createFileService.native.ts ~ line 158 ~ NativeFileService ~ hasPermission',
        hasPermission,
      )
      console.log(
        '🛠 LOG: 🚀 --> ----------------------------------------------------------------------------------------------------------------🛠 LOG: 🚀 -->',
      ...
      if (!hasPermission) {
        ...
        console.log(
          '🛠 LOG: 🚀 --> ~ file: createFileService.native.ts ~ line 170 ~ NativeFileService ~ granted',
          granted,
        )
        console.log(
          '🛠 LOG: 🚀 --> ----------------------------------------------------------------------------------------------------🛠 LOG: 🚀 -->',
    ...
    async openDocument(
      ...
      try {
        ...
        if (
          !documentPickerModule.isCancel(e) &&
          documentPickerModule.isInProgress(e)
        ) {
