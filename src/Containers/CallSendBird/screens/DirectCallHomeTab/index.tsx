...
const DirectCallHomeTab = () => {
  const tabColor = (focused: boolean) =>
    focused ? Palette.background600 : Palette.background300
  return (
    <Tab.Navigator
      screenOptions={{ tabBarShowLabel: false, tabBarHideOnKeyboard: false }}
    >
      <Tab.Screen
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => (
            <SBIcon icon={'CallHistory'} color={tabColor(focused)} />
          ),
        }}
      />
      <Tab.Screen
